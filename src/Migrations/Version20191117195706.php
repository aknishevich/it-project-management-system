 ...
 */
final class Version20191117195706 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE project (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, owner INTEGER DEFAULT NULL, creating_date DATETIME NOT NULL, tasks CLOB DEFAULT NULL --(DC2Type:array)
        )');
        ...
        $this->addSql('CREATE TABLE user_project (user_id INTEGER NOT NULL, project_id INTEGER NOT NULL, PRIMARY KEY(user_id, project_id))');
